...
class Command(BaseCommand):
    ...
    def import_inventory(self):
        ...
        inventory_items = [
            # Base Materials
            ('Yucca', 'BaseMaterial', 'GMS', 15000, 0),
            ('Humic Acid', 'BaseMaterial', 'GMS', 0, 0),
            ('Fulvic Acid', 'BaseMaterial', 'GMS', 0, 0),
            ('Kelp', 'BaseMaterial', 'GMS', 0, 0),
            ('MgCl2', 'BaseMaterial', 'GMS', 0, 0),
            ('MgSO4', 'BaseMaterial', 'GMS', 0, 0),
            ('MnSO4 (Mn)', 'BaseMaterial', 'GMS', 0, 0),
            ('ZnSO4 (Zn)', 'BaseMaterial', 'GMS', 0, 0),
            ('Molybdate (Mo)', 'BaseMaterial', 'GMS', 0, 0),
            ('K2SO4 (K)', 'BaseMaterial', 'KG', 0, 0),
            ('Rock Phosphate', 'BaseMaterial', 'KG', 0, 0),
            ('Caco3 (Chuna)', 'BaseMaterial', 'KG', 0, 0),
            ('Borax (B)', 'BaseMaterial', 'GMS', 0, 0),
            ('Boric Acid', 'BaseMaterial', 'GMS', 0, 0),
            ('CoSO4 (Co)', 'BaseMaterial', 'GMS', 0, 0),
            ('CuSO4 (Copper)', 'BaseMaterial', 'GMS', 0, 0),
            ('FeSO4 (Fe)', 'BaseMaterial', 'GMS', 0, 0),
            ('Lime Stone', 'BaseMaterial', 'KG', 0, 0),
            ('Gypsum', 'BaseMaterial', 'KG', 0, 0),
            ('Trichoderma', 'BaseMaterial', 'GMS', 0, 0),
            ('Pseudomonas', 'BaseMaterial', 'GMS', 0, 0),
            ('Mycorrazae', 'BaseMaterial', 'GMS', 0, 0),
            ('Chelated Mix', 'BaseMaterial', 'GMS', 0, 0),
            ('Chelated Mg', 'BaseMaterial', 'GMS', 0, 0),
            ('Chelated Ca', 'BaseMaterial', 'GMS', 0, 0),
            ('Sugar/Gur', 'BaseMaterial', 'KG', 0, 0),
            # Solutions
            ('Rejuvenate', 'Solutions', 'LTR', 0, 0),
            ('Accelerate', 'Solutions', 'LTR', 0, 0),
            ('Sea Stim', 'Solutions', 'LTR', 0, 0),
            ('Sea Crop', 'Solutions', 'LTR', 0, 0),
            ('Huma Carb', 'Solutions', 'GMS', 0, 0),
            ('Holo K', 'Solutions', 'LTR', 0, 0),
            ('Holo Phos', 'Solutions', 'LTR', 0, 0),
            ('Photo Mag', 'Solutions', 'LTR', 0, 0),
            ('Mn', 'Solutions', 'GMS', 0, 0),
            ('Fe', 'Solutions', 'GMS', 0, 0),
            ('B', 'Solutions', 'GMS', 0, 0),
            ('Mo', 'Solutions', 'GMS', 0, 0),
            ('Co', 'Solutions', 'GMS', 0, 0),
            ('Cu', 'Solutions', 'GMS', 0, 0),
            ('Zn', 'Solutions', 'GMS', 0, 0),
            ('Holo Mac', 'Solutions', 'LTR', 0, 0),
            ('Holo Mic', 'Solutions', 'LTR', 0, 0),
            ('Micro Pak', 'Solutions', 'GMS', 0, 0),
            ('Sea Guard', 'Solutions', 'LTR', 0, 0),
            ('BioBroad+', 'Solutions', 'LTR', 0, 0),
            ('Pepzyme', 'Solutions', 'LTR', 0, 0),
            ('Micro5000', 'Solutions', 'LTR', 0, 0),
            ('Bio Extract', 'Solutions', 'LTR', 0, 0),
            # Tools
            ('Wrench', 'Tools', 'NOS', 0, 0),
            ('Spanner', 'Tools', 'NOS', 0, 0),
            ('Pipe Wrench', 'Tools', 'NOS', 0, 0),
            # Consumables
            ('Nuts', 'Consumables', 'NOS', 0, 0),
            ('Bolts', 'Consumables', 'NOS', 0, 0),
            ('Washer', 'Consumables', 'NOS', 0, 0),
            ('Insulation Tape', 'Consumables', 'NOS', 0, 0),
            # Produce
            ('Black Pepper', 'Produce', 'KG', 0, 0),
            ('Coffee Parchment', 'Produce', 'KG', 0, 0),
            ('Coffee Cherry', 'Produce', 'KG', 0, 0),
            ('Arecanut', 'Produce', 'KG', 0, 0),
            ('Cardamom', 'Produce', 'KG', 0, 0),
            ('Wood', 'Produce', 'MT', 0, 0),
            ('Vermicompost', 'Produce', 'KG', 0, 0),
            # Expense
            ('Labour Exp.', 'Expense', 'NOS', 0, 0),
            ('Contract Labour', 'Expense', 'NOS', 0, 0),
            ('Travelling', 'Expense', 'NOS', 0, 0),
            ('Insulation Tape', 'Expense', 'NOS', 0, 0),
            ('Salary', 'Expense', 'NOS', 0, 0),
            ('Adv to Staff', 'Expense', 'NOS', 0, 0),
            ('Donations', 'Expense', 'NOS', 0, 0),
            ('Jeypore', 'Expense', 'NOS', 0, 0),
            ('Consumables Purchase', 'Expense', 'NOS', 0, 0),
            ('Repair and Maintenance', 'Expense', 'NOS', 0, 0),
            ('Medical Exp', 'Expense', 'NOS', 0, 0),
        ]
        
        created = 0
        for name, category, unit, stock, rate in inventory_items:
